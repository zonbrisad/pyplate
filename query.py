...
class Query:
    ...
    def __init__(self, type: QueryType, query_string: str, query=None,
    ...
    def query(self):
        if self.type == QueryType.STRING:
            self.read_string(self.query_string, self.default)
    ...
    @staticmethod
    def read_integer(question, default=None, min=None, max=None) -> int:
        pass

    @staticmethod
    def read_bool(question, default=False) -> bool:
        pass
